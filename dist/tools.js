export const tools = [
    ...
    },
    {
        ...
        description: "Returns the best available temp suggestion for a given job ID, preferring the lowest current workload.",
        inputSchema: {
            type: "object",
            properties: {
                jobId: {
    ...
    },
    {
        ...
        description: "Explains whether a specific temp can take a specific job, and if not, why not.",
        inputSchema: {
            type: "object",
            properties: {
                jobId: {
