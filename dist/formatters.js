...
export function formatTempDetails(temp) {
    const lines = [
...
export function formatAvailableTemps(jobId, tempsPage) {
...
export function formatBestTempSuggestion(job, tempsPage) {
    if (!tempsPage.items.length) {
...
export function formatTempAvailabilityExplanation(job, temp) {
